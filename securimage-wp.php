    ...
    foreach ($sequence as $part) {
        switch ($part) {
            ...
            case 'captcha': {
                ...
                $captcha_html .= '<span tabindex="-1" style="border-style: none;margin-left:5px;"' .
                    ' title="Refresh Image" ' .
...
function siwp_plugin_options()
{
    ...
    <link rel="stylesheet" href="<?php echo siwp_get_plugin_url() ?>stl.css" type="text/css"/>
    <div class="wrap">
    <div id="icon-options-general" class="icon32"><br/></div>
    <h2>Securimage-WP Options</h2>
    <span class="si-feedback"><a href="http://jehy.ru/articles/2009/02/09/wordpress-plugins/"
                                          target="_blank">Leave a Comment</a> &nbsp; - &nbsp; <a
            href="http://jehy.ru/articles/2009/02/09/wordpress-plugins/" target="_blank">Support/Contact</a></span>
    ...
    <?php if (siwp_show_donate()): ?>
        <div id="donation_plate">
            <h4>
                Donate</h4>

            <div class="si-please-donate">
                <p>If you have found that this plugin has been helpful and saved you time, please consider making a
                    one-time donation. The requested donation amount is <em><a>$2.49 USD</a></em>.</p>

                <p><strong><em>Thank you for using this plugin.</em></strong></p>
            </div>
            <div class="si-donation-form">
                <form target="_top" method="post" action="https://www.paypal.com/cgi-bin/webscr">
                    <input type="hidden" value="_s-xclick" name="cmd"><br>
                    <input type="hidden" value="EE8RM4N7BSNZ6" name="hosted_button_id"><br>
                    ...
                    <img width="1" border="0" height="1" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif"
                         alt=""><br>
                </form>
                <br/><br/>
                <a href="?page=securimage-wp-options&amp;action=dismissdonate">No Thanks</a> &nbsp;-&nbsp; <a
                    href="?page=securimage-wp-options&amp;action=donated">I've Already Donated</a>
            </div>
            <div style="clear: both"></div>
        </div>
    <?php endif; ?>
    ...
    <table class="form-table">
        ...
        <tr valign="top">
            <td valign="top"><a href="<?php echo $_SERVER['PHP_SELF'] ?>?page=securimage-wp-options&amp;action=purge">Purge
                    expired codes now</a></td>
        </tr>
    </table>
    ...
    <tr valign="top">
        <th scope="row">Code Length:<br/><span style="font-size: 0.8em">Does not apply to math CAPTCHA</span>
        </th>
        <td>
    ...
    <tr valign="top">
        <th scope="row">Image Width:<br/><span style="font-size: 0.8em">Image width in pixels from 125-500 (Default: 215)</span>
        </th>
        <td><input type="text" name="siwp_image_width"
                   value="<?php echo get_option('siwp_image_width', 215) ?>"/></td>
    </tr>

    <tr valign="top">
        <th scope="row">Image Height:<br/><span style="font-size: 0.8em">Image height in pixels from 40-200 (Default: 80)</span>
        </th>
        <td><input type="text" name="siwp_image_height"
                   value="<?php echo get_option('siwp_image_height', 80) ?>"/></td>
    </tr>

    <tr valign="top">
        <th scope="row">Image Background Color</th>
        <td><input class="color" type="text" name="siwp_image_bg_color"
                   value="<?php echo get_option('siwp_image_bg_color', 'FFFFFF'); ?>"/></td>
    </tr>

    <tr valign="top">
        <th scope="row">Text Color</th>
        <td><input class="color" type="text" name="siwp_text_color"
                   value="<?php echo get_option('siwp_text_color', '000000'); ?>"/></td>
    </tr>

    <tr valign="top">
        <th scope="row">Number of Distortion Lines</th>
        <td><input type="text" name="siwp_num_lines" value="<?php echo get_option('siwp_num_lines', '6'); ?>"
                   size="5" maxlength="2"/></td>
    </tr>

    <tr valign="top">
        <th scope="row">Distortion Line Color</th>
        <td><input class="color" type="text" name="siwp_line_color"
                   value="<?php echo get_option('siwp_line_color', '000000'); ?>"/></td>
    </tr>

    <tr valign="top">
        <th scope="row">Noise Level (0-10)</th>
        <td><input type="text" name="siwp_noise_level"
                   value="<?php echo get_option('siwp_noise_level', '3'); ?>"/></td>
    </tr>

    <tr valign="top">
        <th scope="row">Noise Color</th>
        <td><input class="color" type="text" name="siwp_noise_color"
                   value="<?php echo get_option('siwp_noise_color', '000000'); ?>"/></td>
    </tr>

    <tr valign="top">
        <th scope="row">Image Signature Text</th>
        <td><input type="text" name="siwp_image_signature"
                   value="<?php echo get_option('siwp_image_signature', ''); ?>"/></td>
    </tr>

    <tr valign="top">
        <th scope="row">Signature Text Color</th>
        <td><input class="color" type="text" name="siwp_signature_color"
                   value="<?php echo get_option('siwp_signature_color', '777777'); ?>"/></td>
    </tr>

    <tr valign="top">
        <th scope="row">Randomize Image Backgrounds</th>
        <td><input type="checkbox" name="siwp_randomize_background"
                   value="1" <?php checked(1, get_option('siwp_randomize_background', 0)) ?> /></td>
    </tr>

    <tr valign="top">
        <th scope="row">Use Mathematic Captcha</th>
        <td><input type="checkbox" name="siwp_use_math"
                   value="1" <?php checked(1, get_option('siwp_use_math', 0)) ?> /></td>
    </tr>
    ...
    <tr valign="top">
        ...
        <td><input type="checkbox" name="siwp_disable_audio"
                   value="1" <?php checked(1, get_option('siwp_disable_audio', 0)) ?> /></td>
    </tr>

    <tr valign="top">
        <th scope="row">Flash Button Icon URL<br/><span style="font-size: 0.8em">For best results, this should be hosted on the same domain as WordPress</span>
        </th>
        <td><input type="text" name="siwp_flash_icon"
                   value="<?php echo get_option('siwp_flash_icon', siwp_default_flash_icon()); ?>"/></td>
    </tr>

    <tr valign="top">
        <th scope="row">Flash Button Background Color</th>
        <td><input class="color" type="text" name="siwp_flash_bgcol"
                   value="<?php echo get_option('siwp_flash_bgcol', '#ffffff') ?>"/></td>
    </tr>
    ...
    <tr valign="top">
        <th scope="row">Display Sequence<br/><span
                style="font-size: 0.8em">Control the arrangement of CAPTCHA inputs<br/>&quot;captcha&quot; denotes the image captcha, audio, and refresh icon<br/>&quot;break&quot; indicates a line break<br/>&quot;label&quot; denotes the input label<br/>&quot;input&quot; denotes the captcha text input</span>
        </th>
        <td><select name="siwp_display_sequence">
                <?php foreach (siwp_get_sequence_list() as $sequence): ?>
                    <option
                        value="<?php echo $sequence ?>"<?php if ($sequence == get_option('siwp_display_sequence', 'captcha-input-label')): ?> selected="selected"<?php endif; ?>><?php echo $sequence ?></option>
                <?php endforeach; ?>
            </select>
        </td>
    </tr>
    ...
    <tr valign="top">
        ...
        <td>
            <input type="checkbox" name="siwp_use_refresh_text"
                   value="1" <?php checked(1, get_option('siwp_use_refresh_text', 0)) ?> />
            &nbsp; Display Text:
            <input type="text" name="siwp_refresh_text"
                   value="<?php echo get_option('siwp_refresh_text', 'Different Image') ?>"/>
        </td>
    </tr>

    <tr valign="top">
        <th scope="row">Fix CAPTCHA Position<br/><span style="font-size: 0.8em">If CAPTCHA shows up below comment submit button, enable this option</span>
        </th>
        <td><input type="checkbox" name="siwp_position_fix"
                   value="1" <?php checked(1, get_option('siwp_position_fix', 0)) ?> /></td>
    </tr>

    <tr valign="top">
        <th scope="row">Show "Protected By" Link</th>
        <td><input type="checkbox" name="siwp_show_protected_by"
                   value="1" <?php checked(1, get_option('siwp_show_protected_by', 1)) ?> /></td>
    </tr>

    <tr valign="top">
        <th scope="row">CAPTCHA expiration time<br/><span style="font-size: 0.8em">In seconds, how long before the CAPTCHA expires and is no longer valid</span>
        </th>
        <td><input type="text" name="siwp_captcha_expiration"
                   value="<?php echo siwp_get_captcha_expiration() ?>"/></td>
    </tr>

    <tr valign="top">
        <th scope="row">Debug Image Errors:</th>
        <td>
            <input type="checkbox" name="siwp_debug_image"
                   value="1" <?php checked(1, get_option('siwp_debug_image', 0)) ?> />
            Click to <a href="<?php echo siwp_get_captcha_image_url() ?>" target="_new">view image directly</a>.<br/>
				<span style="font-size: 0.8em">
					If any PHP errors or warnings are displayed, visit the <a href="http://www.phpcaptcha.org/faq/"
                                                                              target="_new">Securimage FAQ Page</a> to see if the problem is listed.  If not, please file a bug report using the <a
                        href="http://jehy.ru/articles/2009/02/09/wordpress-plugins/" target="_new">contact</a> page.<br/>
					Use the <a href="<?php echo siwp_get_plugin_url() ?>siwp_test.php" target="_new">Securimage Test
                        Script</a> to verify that your server meets the requirements.
				</span>
        </td>
    </tr>
    ...
    <tr valign="top">
        ...
        <td><input type="text" name="siwp_css_clsimg" value="<?php echo get_option('siwp_css_clsimg', ''); ?>"/>
        </td>
    </tr>
    <tr valign="top">
        <th scope="row">CSS Style to add to CAPTCHA &lt;img&gt; tag</th>
        <td><input type="text" name="siwp_css_cssimg" value="<?php echo get_option('siwp_css_cssimg', ''); ?>"/>
        </td>
    </tr>

    <tr valign="top">
        <th scope="row">Class(es) to add to CAPTCHA &lt;input&gt; tag</th>
        <td><input type="text" name="siwp_css_clsinput"
                   value="<?php echo get_option('siwp_css_clsinput', ''); ?>"/></td>
    </tr>
    <tr valign="top">
        <th scope="row">CSS Style to add to CAPTCHA &lt;input&gt; tag</th>
        <td><input type="text" name="siwp_css_cssinput"
                   value="<?php echo get_option('siwp_css_cssinput', ''); ?>"/></td>
    </tr>

    <tr valign="top">
        <th scope="row">Class(es) to add to CAPTCHA &lt;label&gt; tag</th>
        <td><input type="text" name="siwp_css_clslabel"
                   value="<?php echo get_option('siwp_css_clslabel', ''); ?>"/></td>
    </tr>
    <tr valign="top">
        <th scope="row">CSS style to add to CAPTCHA &lt;label&gt; tag</th>
        <td><input type="text" name="siwp_css_csslabel"
                   value="<?php echo get_option('siwp_css_csslabel', ''); ?>"/></td>
    </tr>
    </table>
